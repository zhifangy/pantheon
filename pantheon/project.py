...
class Layout:
    ...
    def get_confounds_file(
        ...
        """Gets fMRIPrep output confounds regressor file.
        ...
        Returns:
            A list of fMRIPrep generated confounds regressor file.
        """
...
class Project(Layout):
    ...
    def read_confounds(
        ...
        run_id: Optional[Union[str, int, list[str], list[int]]] = None,
        ses_id: Optional[str] = None,
        confounds_list: Optional[list[str]] = [
            "trans_x",
            "trans_y",
            "trans_z",
            "rot_x",
        ...
        """Reads confounds regressor timeseries to dataframe.
        ...
        Args:
            ...
            run_id: RunID. Optional.
            ses_id: SessionID. Optional.
            confounds_list: A list of confounds regressor names. If it's
        ...
        Returns:
            A dataframe of confounds regressors generated by fMRIPrep.
        """

        sub_id = conform_sub_id(sub_id, with_prefix=True)
        file_list = self.get_confounds_file(
        ...
        if confounds_list:
            df = df.loc[:, ["sub_id", "task_id", "run_id"] + confounds_list]
        return df
